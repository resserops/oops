...
KeyValueIO<Info, Field> kvio{
    {{Field::NAME, "Name", CW<&Info::name>},
     ...
     {Field::KTHREAD, "Kthread", CW<&Info::kthread>, "{:d}"},
     ...
     {Field::CORE_DUMPING, "CoreDumping", CW<&Info::core_dumping>, "{:d}"},
     {Field::THP_ENABLED, "THP_enabled", CW<&Info::thp_enabled>, "{:d}"},
     ...
     {Field::NO_NEW_PRIVS, "NoNewPrivs", CW<&Info::no_new_privs>, "{:d}"},
